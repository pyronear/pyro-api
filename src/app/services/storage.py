...
class S3Bucket:
    ...
    async def upload_file(self, bucket_key: str, file_binary: bytes, bucket_name: str) -> bool:
...
s3_bucket = S3Bucket(cfg.S3_REGION, cfg.S3_ENDPOINT_URL, cfg.S3_ACCESS_KEY, cfg.S3_SECRET_KEY, cfg.S3_PROXY_URL)
