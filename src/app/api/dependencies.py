...
from app.crud import CameraCRUD, DetectionCRUD, OrganizationCRUD, StreamCRUD, UserCRUD, WebhookCRUD
...
def get_stream_crud(session: AsyncSession = Depends(get_session)) -> StreamCRUD:
    return StreamCRUD(session=session)
