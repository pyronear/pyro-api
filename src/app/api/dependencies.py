...
from app.crud import CameraCRUD, DetectionCRUD, SiteCRUD, UserCRUD
...
def get_site_crud(session: AsyncSession = Depends(get_session)) -> SiteCRUD:
    return SiteCRUD(session=session)
