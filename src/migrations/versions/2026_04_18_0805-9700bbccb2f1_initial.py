...
def upgrade() -> None:
    ...
    op.create_table('occlusion_masks',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('is_wildfire', sa.Enum('WILDFIRE_SMOKE', 'OTHER_SMOKE', 'OTHER', name='annotationtype'), nullable=True),
    ...
    op.create_table('alerts_sequences',
