...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["agent"], {"sub": "123", "scopes": ["agent"]}, None, None, {"sub": 123, "scopes": ["agent"]}),
        (["camera"], {"sub": "123", "scopes": ["camera"]}, None, None, {"sub": 123, "scopes": ["camera"]}),
        (["user"], {"sub": "123", "scopes": ["user"]}, None, None, {"sub": 123, "scopes": ["user"]}),
