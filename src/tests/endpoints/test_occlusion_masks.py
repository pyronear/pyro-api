...
@pytest.mark.parametrize(
    ...
    [
        (None, {"pose_id": 1, "mask": "(0.1,0.1,0.9,0.9,0.5)"}, 401, "Not authenticated"),
        (2, {"pose_id": 1, "mask": "(0.1,0.1,0.9,0.9,0.5)"}, 403, "Incompatible token scope."),
        (0, {"pose_id": 0, "mask": "(0.1,0.1,0.9,0.9,0.5)"}, 422, None),
        (0, {"pose_id": 999, "mask": "(0.1,0.1,0.9,0.9,0.5)"}, 404, "Table Pose has no corresponding entry."),
        (1, {"pose_id": 3, "mask": "(0.1,0.1,0.9,0.9,0.5)"}, 403, "Access forbidden."),  # agent org 1, camera org 2
        (0, {"pose_id": 1, "mask": "invalid"}, 422, None),
        (0, {"pose_id": 1, "mask": "(0.1,0.1,0.9,0.9,0.5)"}, 201, None),
        (1, {"pose_id": 1, "mask": "(0.1,0.1,0.9,0.9,1)"}, 201, None),
    ],
)
@pytest.mark.asyncio
...
@pytest.mark.parametrize(
    ...
    [
        (None, 1, {"mask": "(0.2,0.2,0.8,0.8,0.5)"}, 401, "Not authenticated"),
        (2, 1, {"mask": "(0.2,0.2,0.8,0.8,0.5)"}, 403, "Incompatible token scope."),
        (0, 0, {"mask": "(0.2,0.2,0.8,0.8,0.5)"}, 422, None),
        (0, 999, {"mask": "(0.2,0.2,0.8,0.8,0.5)"}, 404, "Table OcclusionMask has no corresponding entry."),
        (1, 4, {"mask": "(0.2,0.2,0.8,0.8,0.5)"}, 403, "Access forbidden."),  # agent org mismatch
        (0, 1, {"mask": "bad_format"}, 422, None),
        (0, 1, {"mask": "(0.2,0.2,0.8,0.8,0.5)"}, 200, None),
        (1, 1, {"mask": "(0.3,0.3,0.7,0.7,1)"}, 200, None),
    ],
)
@pytest.mark.asyncio
