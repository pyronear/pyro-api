...
def main(args):
    ...
    superuser_pwd = "superadmin_pwd"  # ruff:ignore[hardcoded-password-string]
    ...
    agent_login = "my_user"
    agent_pwd = "my_pwd"  # ruff:ignore[hardcoded-password-string]
    ...
    api_request("get", f"{args.endpoint}/users", superuser_auth)
    # Modify access
    new_pwd = "my_new_pwd"  # ruff:ignore[hardcoded-password-string]
