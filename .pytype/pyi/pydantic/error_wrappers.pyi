...
def error_dict(exc: Exception, config: Type[pydantic.main.BaseConfig], loc: Tuple[Union[int, str], ...]) -> Dict[str, Any]: ...
def flatten_errors(errors: Sequence, config: Type[pydantic.main.BaseConfig], loc: Optional[Tuple[Union[int, str], ...]] = ...) -> Generator[Dict[str, Any], None, None]: ...
