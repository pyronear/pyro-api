...
class ConnectionEvents(sqlalchemy.event.base.Events):
    __doc__: str
    _dispatch_target: Type[sqlalchemy.engine.interfaces.Connectable]
...
class DDLEvents(sqlalchemy.event.base.Events):
    __doc__: str
    _dispatch_target: Type[sqlalchemy.sql.base.SchemaEventTarget]
    _target_class_doc: str
...
class DialectEvents(sqlalchemy.event.base.Events):
    __doc__: str
    _dispatch_target: Type[sqlalchemy.engine.interfaces.Dialect]
    _target_class_doc: str
    @classmethod
