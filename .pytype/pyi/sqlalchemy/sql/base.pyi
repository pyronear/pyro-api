...
class ColumnCollection(sqlalchemy.util._collections.OrderedProperties):
    __doc__: str
    __eq__: Any
    __hash__: None
...
class ColumnSet(sqlalchemy.util._collections.OrderedSet):
    __eq__: Any
...
class DialectKWArgs:
    ...
    _kw_registry: sqlalchemy.util._collections.PopulateDict
    dialect_kwargs: Any
    dialect_options: Any
    kwargs: Any
...
class Executable(Generative):
    __doc__: str
    _bind: None
    _execution_options: sqlalchemy.util._collections.immutabledict
    bind: Any
    execution_options: Any
    supports_execution: bool
    def execute(self, *multiparams, **params) -> Any: ...
    def get_execution_options(self) -> sqlalchemy.util._collections.immutabledict: ...
...
class ImmutableColumnCollection(sqlalchemy.util._collections.ImmutableProperties, ColumnCollection):
    def __init__(self, data, all_columns) -> None: ...
    def extend(self: sqlalchemy.util._collections.ImmutableContainer, *arg, **kw) -> NoReturn: ...
    def remove(self: sqlalchemy.util._collections.ImmutableContainer, *arg, **kw) -> NoReturn: ...
...
class SchemaVisitor(sqlalchemy.sql.visitors.ClauseVisitor):
    __doc__: str
